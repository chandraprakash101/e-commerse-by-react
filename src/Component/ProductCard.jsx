...
const ProductCard = ({ data }) => {
  // Data object se properties ko destructure kiya
  const { thumbnail, title, brand, description, price, discountPercentage, rating } = data;

  // Purani price (original price) calculate karne ka math
